...
/** This Class Provides useful Methods For Using Firebase Realtime database.
 * **/
public class FirebaseUtil {
    ...
    public interface FirebaseUtilPhoneAuthProvider
    {
        //the method is sending verification code
        //the country id is concatenated
        //you can take the country id as user input as well
        void sendVerificationCode(String mobile, PhoneAuthProvider.OnVerificationStateChangedCallbacks callbacks);
        void verifyVerificationCode(String code);
        void signUpWithPhoneAuthCredential(PhoneAuthCredential credential, OnCompleteListener<AuthResult> onCompleteListener);
    }
